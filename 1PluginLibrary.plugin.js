/**
 * @name OnesPluginLibrary
 * @version 1.2.34
 * @authorLink https://twitter.com/BlackusPL
 * @website https://github.com/BlackusPL/OnesPluginLibrary
 * @source https://raw.githubusercontent.com/rauenzi/BDPluginLibrary/master/release/OnesPluginLibrary.plugin.js
 */
...
/***/ ((module) => {
    ...
    module.exports = {
        info: {
            ...
            github_raw: "https://raw.githubusercontent.com/rauenzi/BDPluginLibrary/master/release/OnesPluginLibrary.plugin.js"
        },
        changelog: [
            {title: "Library Overhaul",type: "improved",items: ["Overhauled a good portion of the library."]},
            {title: "What's Back?",type: "fixed",items: ["`DiscordAPI` module back (some plugins need it).","Wait for new version of ZeresPluginLibrary where `DiscordAPI` will back."]}
        ],
        main: "plugin.js"
    };
    ...
    /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((BasePlugin, Library) => {
        ...
        const PluginLibrary = class PluginLibrary extends BasePlugin {
            ...
            _reloadPlugins() {
                const list = BdApi.Plugins.getAll().reduce((acc, val) => {
                    ...
                    if (name === "OnesPluginLibrary") return acc;
                    acc.push(name);
                    return acc;
                }, []);
        ...
        window.OnesPluginLibrary = PluginLibrary;
    ...
    class Popouts {
        ...
        static initialize() {
            ...
            this.container = Object.assign(document.createElement("div"), {
                className: "OnesPluginLibraryPopoutsRenderer",
                style: "display: none;"
            });
        
            this.layerContainer = Object.assign(document.createElement("div"), {
                id: "OnesPluginLibraryPopouts",
        ...
        static dispose() {
            ...
            const container = document.querySelector(".OnesPluginLibraryPopoutsRenderer");
            const layerContainer = document.querySelector("#OnesPluginLibraryPopouts");
    ...
    */
    ...
    module.exports.OnesPluginLibrary = __webpack_exports__["default"];
    /******/ })()
    ;
    /*@end@*/